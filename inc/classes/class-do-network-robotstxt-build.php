...
final class Do_Network_Robotstxt_Build {
	 ...
	 */
	private function build_robotstxt_rules__premium_only( $site_id ) {
		$robotstxt_rules = new \MsRobotstxtManager\Pro_Build_Append_Rules();
		$robotstxt_rules->init( $site_id );
	}//end build_robotstxt_rules__premium_only()
}//end class
